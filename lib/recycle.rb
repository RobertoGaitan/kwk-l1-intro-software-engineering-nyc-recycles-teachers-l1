...
def all_data(first_recycling_bin)
  first_recycling_bin.each_value {|value|
      puts "#{value}"
    }
...
#This method should print out each key and value in the hash in a sentence like
#this: `The #{key} is #{value}`
